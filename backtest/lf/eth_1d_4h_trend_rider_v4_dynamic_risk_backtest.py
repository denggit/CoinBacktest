...
# -*- coding: utf-8 -*-
"""
ETH 1D + 4H Trend Rider V4 Dynamic Risk Backtest
====================================

放置位置建议：backtest/lf/eth_1d_4h_trend_rider_v4_dynamic_risk_backtest.py
运行示例：
    python backtest/lf/eth_1d_4h_trend_rider_v4_dynamic_risk_backtest.py --start-date 2023-01-01 --end-date 2026-06-15

策略定位：
    低频趋势骑乘 V4。
    在 V3 的年度稳定性基础上新增动态风险：
...
STRATEGY_NAME = "eth_1d_4h_trend_rider_v4_dynamic_risk"
REPORT_STRATEGY_NAME = "ETH_1D_4H_TrendRider_V4_DynamicRisk_LF"
...
def print_summary(summary: dict[str, Any], out_dir: Path) -> None:
    print("\n" + "=" * 86)
    print("ETH 1D+4H Trend Rider V4 Dynamic Risk Backtest Summary")
    print("=" * 86)
...
def parse_args() -> argparse.Namespace:
    ...
    p = argparse.ArgumentParser(description="ETH 1D+4H Trend Rider V4 with dynamic risk, daily regime, 4H trend entries, R-lock protection.")
    ...
    p.add_argument("--out-dir", default="data/reports/lf/eth_1d_4h_trend_rider_v4_dynamic_risk")
    return p.parse_args()
