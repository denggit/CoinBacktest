...
放置位置建议：backtest/eth_donchian_regime_reclaim_backtest.py
运行示例：
    python backtest/eth_donchian_regime_reclaim_backtest.py --start-date 2023-01-01 --end-date 2026-06-17
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--out-dir", default="data/reports/eth_donchian_regime_reclaim")
    return p.parse_args()
