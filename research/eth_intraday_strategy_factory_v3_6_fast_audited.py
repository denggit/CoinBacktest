#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""ETH Intraday Strategy Factory V3.6 FAST AUDITED - single-file CoinBacktest research script.
...
---------------------------------------
python research/eth_intraday_strategy_factory_v3_6_fast_audited.py --mode smoke --max-specs 30 --out-dir data/reports/research/eth_intraday_factory_v3_6_smoke
python research/eth_intraday_strategy_factory_v3_6_fast_audited.py --mode core --max-specs 400 --out-dir data/reports/research/eth_intraday_factory_v3_6_core
python research/eth_intraday_strategy_factory_v3_6_fast_audited.py --mode wide --max-specs 1200 --robustness-top-n 80 --write-trades --out-dir data/reports/research/eth_intraday_factory_v3_6_wide
...
SCRIPT_NAME = "eth_intraday_strategy_factory_v3_6_fast_audited"
...
class RunConfig:
    ...
    out_dir: str = "data/reports/research/eth_intraday_strategy_factory_v3_6_fast_audited"
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="ETH intraday strategy factory V3.6 FAST, single-file CoinBacktest research script.", formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    ...
    p.add_argument("--out-dir", default="data/reports/research/eth_intraday_strategy_factory_v3_6_fast_audited")
    return p.parse_args()
