#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Range-bar + footprint event entry lab for ETH OKX research.
...
SCRIPT_NAME = "RangeFootprintEventLabV3"
...
class Config:
    ...
    out_dir: Path = Path("data/reports/research/range_footprint_event_lab_v3")
        ...
        for feature in FEATURE_COLUMNS:
            ...
            for target in targets:
                ...
                if ok.sum() < cfg.min_bin_events:
                    continue
                corr = x.loc[ok].corr(y.loc[ok], method="spearman")
                rows.append({
                    "event_type": event_type,
                    "side": side,
                    "entry_mode": entry_mode,
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--out-dir", default="data/reports/research/range_footprint_event_lab_v3")
...
def main() -> None:
    ...
    events_path = cfg.out_dir / "range_footprint_event_lab_v3_events.csv"
    summary_path = cfg.out_dir / "range_footprint_event_lab_v3_summary.csv"
    yearly_path = cfg.out_dir / "range_footprint_event_lab_v3_yearly.csv"
    binning_path = cfg.out_dir / "range_footprint_event_lab_v3_feature_binning.csv"
    corr_path = cfg.out_dir / "range_footprint_event_lab_v3_feature_correlations.csv"
    config_path = cfg.out_dir / "range_footprint_event_lab_v3_config.json"
