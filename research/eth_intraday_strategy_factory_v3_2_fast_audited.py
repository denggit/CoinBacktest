...
---------------------------------------
python research/eth_intraday_strategy_factory_v3_2_fast_audited.py --mode smoke --max-specs 30 --out-dir data/reports/research/eth_intraday_factory_v3_1_smoke
python research/eth_intraday_strategy_factory_v3_2_fast_audited.py --mode core --max-specs 400 --out-dir data/reports/research/eth_intraday_factory_v3_1_core
python research/eth_intraday_strategy_factory_v3_2_fast_audited.py --mode wide --max-specs 1200 --robustness-top-n 80 --write-trades --out-dir data/reports/research/eth_intraday_factory_v3_1_wide
...
SCRIPT_NAME = "eth_intraday_strategy_factory_v3_2_fast_audited"
...
class RunConfig:
    ...
    out_dir: str = "data/reports/research/eth_intraday_strategy_factory_v3_2_fast_audited"
...
def write_data_diagnostics(bars: pd.DataFrame, df: pd.DataFrame, cfg: RunConfig, arrays: BacktestArrays, out_dir: Path) -> pd.DataFrame:
    ...
    for col in required_cols:
        ...
        if col in df.columns:
            ...
            if col in {"volume", "trades_count", "buy_notional", "sell_notional", "delta_notional"}:
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--out-dir", default="data/reports/research/eth_intraday_strategy_factory_v3_2_fast_audited")
    return p.parse_args()
