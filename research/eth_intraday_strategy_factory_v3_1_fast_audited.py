#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""ETH Intraday Strategy Factory V3.1 FAST AUDITED - single-file CoinBacktest research script.
...
---------------------------------------
python research/eth_intraday_strategy_factory_v3_fast.py --mode smoke --max-specs 30 --out-dir data/reports/research/eth_intraday_factory_v3_1_smoke
python research/eth_intraday_strategy_factory_v3_fast.py --mode core --max-specs 400 --out-dir data/reports/research/eth_intraday_factory_v3_1_core
python research/eth_intraday_strategy_factory_v3_fast.py --mode wide --max-specs 1200 --robustness-top-n 80 --write-trades --out-dir data/reports/research/eth_intraday_factory_v3_1_wide
...
SCRIPT_NAME = "eth_intraday_strategy_factory_v3_1_fast_audited"
...
class RunConfig:
    ...
    out_dir: str = "data/reports/research/eth_intraday_strategy_factory_v3_1_fast_audited"
...
def verify_fast_exactness(
    ...
    *,
    ...
    verify_specs = specs[: max(0, int(cfg.verify_fast_exactness_specs))]
    print(f"[AUDIT] Fast exactness check: specs={len(verify_specs):,}", flush=True)
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--verify-fast-exactness", action="store_true", help="Run slow bar-by-bar reference on the first N specs and fail if fast path differs.")
    p.add_argument("--verify-fast-exactness-specs", type=int, default=30, help="Number of specs to compare in fast exactness audit.")
    p.add_argument("--out-dir", default="data/reports/research/eth_intraday_strategy_factory_v3_1_fast_audited")
    return p.parse_args()
