#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Run R03.3 future market-process forecast research."""
...
from src.ai_research.future_process_forecast.pipeline import run_pipeline
...
def main() -> int:
    ...
    print(f"[R03.3] decision={result.decision}")
    print(f"[R03.3] report={result.report_dir}")
