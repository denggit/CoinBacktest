#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""CLI for R03.4 state-context opening-value ablation."""
...
from src.ai_research.state_context_ablation import run_state_context_ablation
...
def main(argv: list[str] | None = None) -> int:
    ...
    result = run_state_context_ablation(
