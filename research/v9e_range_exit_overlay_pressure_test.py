...
def load_summary(run_dir: Path, scenario: RunScenario, scenario_type: str) -> dict[str, Any]:
    ...
    for k in [
        ...
        "range_exit_min_hold_bars", "range_exit_contra_imbalance", "range_exit_bad_close_pos",
...
def main() -> int:
    ...
    if not summary_df.empty:
        preferred = [
            ...
            "total_fees", "range_exit_trade_count", "range_exit_avg_peak_r", "range_exit_avg_giveback_frac",
        ...
        summary_path = root_out / "v9e_range_exit_overlay_pressure_summary.csv"
        summary_df.to_csv(summary_path, index=False)
        print("\n" + "=" * 140)
        print("V9E Range Exit Overlay Pressure Summary")
        print("=" * 140)
    ...
    with (root_out / "v9e_range_exit_overlay_pressure_config.json").open("w", encoding="utf-8") as f:
