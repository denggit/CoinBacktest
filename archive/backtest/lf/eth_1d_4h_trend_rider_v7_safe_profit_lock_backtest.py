...
# -*- coding: utf-8 -*-
"""
ETH 1D + 4H Trend Rider V7 SAFE Profit Lock Backtest
====================================

放置位置建议：backtest/lf/eth_1d_4h_trend_rider_v7_safe_profit_lock_backtest.py
运行示例：
    python backtest/lf/eth_1d_4h_trend_rider_v7_safe_profit_lock_backtest.py --start-date 2023-01-01 --end-date 2026-06-15

策略定位：
    低频趋势骑乘 V7。
    在 V6 SAFE 版本基础上升级利润保护：
...
STRATEGY_NAME = "eth_1d_4h_trend_rider_v7_safe_profit_lock"
REPORT_STRATEGY_NAME = "ETH_1D_4H_TrendRider_V7_SafeProfitLock_LF"
...
def print_summary(summary: dict[str, Any], out_dir: Path) -> None:
    print("\n" + "=" * 86)
    print("ETH 1D+4H Trend Rider V7 SAFE Profit Lock Backtest Summary")
    print("=" * 86)
...
def parse_args() -> argparse.Namespace:
    ...
    p = argparse.ArgumentParser(description="ETH 1D+4H Trend Rider V7 SAFE profit-lock version with quality risk sizing and no same-bar stop update.")
    ...
    p.add_argument("--out-dir", default="data/reports/lf/eth_1d_4h_trend_rider_v7_safe_profit_lock")
    return p.parse_args()
