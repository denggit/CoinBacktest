...
STRATEGY_NAME = "eth_lf_portfolio_v7b_micro_confirmation"
REPORT_STRATEGY_NAME = "ETH_LF_Portfolio_V7B_MicroConfirmation"
...
def print_summary(summary: dict[str, Any], out_dir: Path) -> None:
    print("\n" + "=" * 92)
    print("ETH LF Portfolio V7B Micro Confirmation Risk Filter Backtest Summary")
    print("=" * 92)
...
def parse_args() -> argparse.Namespace:
    ...
    p = argparse.ArgumentParser(description="ETH LF Portfolio V7B: V6 base + range/footprint micro confirmation risk filter.")
...
def main() -> int:
    ...
    summary["conflict_rule"] = "Momentum V3 first; Bear V3 standalone second; Bull Reclaim V2 long only when Momentum/Bear silent; range/footprint micro confirmation only risk-filters entry; no hedge."
