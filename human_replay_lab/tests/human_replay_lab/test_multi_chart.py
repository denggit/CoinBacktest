...
def test_soxl_episode_is_0730_et_and_shared_marker_keeps_source_context(tmp_path: Path) -> None:
    ...
    episode = app.create_episode({"symbol": "SOXL", "mode": "specific", "start_date": "2025-01-02"})
    assert episode["cursor_time"] == "2025-01-02 07:30:00"
    ...
    app.add_event(episode["id"], {
        ...
        "payload": {
            "kind": "BSL",
            "anchor_time": "2025-01-02 07:00:00",
...
def test_step_returns_incremental_chart_updates_without_full_snapshot(tmp_path: Path) -> None:
    ...
    assert result["episode"]["cursor_time"] == "2025-01-02 07:32:00"
